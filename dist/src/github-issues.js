...
export const createIssue = async ({ title, labels }) => {
    let response;
    console.log("Line28");
    try {
...
export const updateIssue = async ({ title, issueNumber, state }) => {
    let response;
    console.log("Line47");
    try {
...
export const deleteIssue = async ({ node_id }) => {
...
export const handleSyncIusses = async (req, res) => {
